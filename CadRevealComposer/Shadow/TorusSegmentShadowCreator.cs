...
public static class TorusSegmentShadowCreator
{
    ...
    public static APrimitive CreateShadow(this TorusSegment torusSegment)
    {
        ...
        var height = torusSegment.TubeRadius * 2 * 0.001f; // TODO Scaling down shouldn't be necessary
        var side = torusSegment.Radius * 2 * 0.001f; // TODO Scaling down shouldn't be necessary
