    ...
    )
    {
        using (new TeamCityLogBlock("Mesh Reduction Stats"))
        {
            Console.WriteLine(
                ...
                Percent of Before Vertices of Triangle Meshes: {(
                    meshLogObject.SimplificationAfterVertexCount / (float)meshLogObject.SimplificationBeforeVertexCount
                ):P2}
                """
            );
            Console.WriteLine("");
            Console.WriteLine(
                ...
                Percent of Before Triangles of Triangle Meshes: {(
                    meshLogObject.SimplificationAfterTriangleCount
                    / (float)meshLogObject.SimplificationBeforeTriangleCount
                ):P2}
                """
            );
            Console.WriteLine("");
            Console.WriteLine(
                ...
                Percent of Before Vertices of Instanced Meshes: {(
                    instancedLogObject.SimplificationAfterVertexCount
                    / (float)instancedLogObject.SimplificationBeforeVertexCount
                ):P2}
                """
            );
            Console.WriteLine("");
            Console.WriteLine(
                ...
                Percent of Before Triangles of Instanced Meshes: {(
                    instancedLogObject.SimplificationAfterTriangleCount
                    / (float)instancedLogObject.SimplificationBeforeTriangleCount
                ):P2}
                """
            );
            Console.WriteLine("");
