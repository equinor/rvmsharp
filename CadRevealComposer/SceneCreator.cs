...
public static class SceneCreator
{
    ...
    public static void ExportSector(SectorInfo sector, string outputDirectory)
    {
        ...
        {
            Console.WriteLine($"NOTE: Sector {sector.SectorId} contains no geometries, no sector file created.");
        }
    }

    internal static void WriteZonesSceneFiles(ImmutableArray<SectorInfo> sectorsWithDownloadSize, ModelParameters modelParameters, DirectoryInfo outputDirectory, ulong currentMaxGeneratedIndex, CameraPositioning.CameraPosition cameraPosition)
    {
