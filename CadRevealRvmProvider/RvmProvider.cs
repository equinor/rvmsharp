...
public class RvmProvider : IModelFormatProvider
{
    ...
    public APrimitive[] ProcessGeometries(APrimitive[] geometries,
        ...
        var facetGroupsWithEmbeddedProtoMeshes = geometries
            ...
            .Select(p => new RvmTesselator.RvmFacetGroupWithProtoMesh(p, p.FacetGroup.Version, p.FacetGroup.Matrix,
        ...
        var meshes = RvmTesselator.TessellateAndOutputInstanceMeshes(
