...
internal class RvmRectangularTorusConverterTests
{
    ...
    public void RvmRectangularTorusConverter_WhenAngleIs2Pi_ReturnsTorusWithoutCaps()
    {
        ...
        var geometries = torus.ConvertToRevealPrimitive(_treeIndex, Color.Red, logObject).ToArray();
    ...
    {
        var logObject = new FailedPrimitivesLogObject();
        var geometries = _rvmRectangularTorus.ConvertToRevealPrimitive(_treeIndex, Color.Red, logObject).ToArray();
