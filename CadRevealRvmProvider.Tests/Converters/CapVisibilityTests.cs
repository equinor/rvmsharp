...
public class CapVisibilityTests
{
    ...
    public void CalculateCapVisibility_TestSnoutCapMatch_TwoSnouts()
    {
        ...
        var p1El1 = VectorD.Build.Dense(new double[] { ellipse1.Ellipse2DPolar.SemiMajorAxis, 0.0, 0.0, 1.0 });
        var p2El1 = VectorD.Build.Dense(new double[] { 0.0, ellipse1.Ellipse2DPolar.SemiMinorAxis, 0.0, 1.0 });
        var p1El2 = VectorD.Build.Dense(new double[] { ellipse2.Ellipse2DPolar.SemiMajorAxis, 0.0, 0.0, 1.0 });
        var p2El2 = VectorD.Build.Dense(new double[] { 0.0, ellipse2.Ellipse2DPolar.SemiMinorAxis, 0.0, 1.0 });
        ...
        (var snout1N, var snout1Dc) = GeometryHelper.GetPlaneFromShearAndPoint(
            snout1.BottomShearX,
            snout1.BottomShearY,
            snout1CapCenter
        );
        ...
        var distance10 = snout1N.X * ptOrigEll1[0] + snout1N.Y * ptOrigEll1[1] + snout1N.Z * ptOrigEll1[2] + snout1Dc;
        var distance11 = snout1N.X * ptPt1Ell1[0] + snout1N.Y * ptPt1Ell1[1] + snout1N.Z * ptPt1Ell1[2] + snout1Dc;
        var distance12 = snout1N.X * ptPt2Ell1[0] + snout1N.Y * ptPt2Ell1[1] + snout1N.Z * ptPt2Ell1[2] + snout1Dc;
        ...
        (var snout2N, var snout2Dc) = GeometryHelper.GetPlaneFromShearAndPoint(
            snout2.TopShearX,
            snout2.TopShearY,
            snout2CapCenter
        );
        ...
        var distance20 = snout2N.X * ptOrigEll2[0] + snout2N.Y * ptOrigEll2[1] + snout2N.Z * ptOrigEll2[2] + snout2Dc;
        var distance21 = snout2N.X * ptPt1Ell2[0] + snout2N.Y * ptPt1Ell2[1] + snout2N.Z * ptPt1Ell2[2] + snout2Dc;
        var distance22 = snout2N.X * ptPt2Ell2[0] + snout2N.Y * ptPt2Ell2[1] + snout2N.Z * ptPt2Ell2[2] + snout2Dc;
    ...
    public void CalculateCapVisibility_TestSnoutCapMatch_RotatedCylindersWithDifferentShear()
    {
        ...
        var origin = VectorD.Build.Dense(new double[] { 0.0, 0.0, 0.0, 1.0 });
        var p1El1 = VectorD.Build.Dense(new double[] { snout1TopCap.Ellipse2DPolar.SemiMajorAxis, 0.0, 0.0, 1.0 });
        var p2El1 = VectorD.Build.Dense(new double[] { 0.0, snout1TopCap.Ellipse2DPolar.SemiMinorAxis, 0.0, 1.0 });
        var p1El2 = VectorD.Build.Dense(new double[] { snout2BottomCap.Ellipse2DPolar.SemiMajorAxis, 0.0, 0.0, 1.0 });
        var p2El2 = VectorD.Build.Dense(new double[] { 0.0, snout2BottomCap.Ellipse2DPolar.SemiMinorAxis, 0.0, 1.0 });
