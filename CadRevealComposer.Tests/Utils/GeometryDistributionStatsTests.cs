...
public class GeometryDistributionStatsTests
{
    ...
    public void Constructor_CountsPrimitivesCorrectly()
    {
        ...
        var primitives = new APrimitive[]
        {
            ...
            new Box(default, default, default, default, default),
            new Cone(default, default, default, default, default, default, default, default, default, default, default),
            new Cone(default, default, default, default, default, default, default, default, default, default, default),
            new EllipsoidSegment(default, default, default, default, default, default, default, default, default),
            new EllipsoidSegment(default, default, default, default, default, default, default, default, default),
            new TriangleMesh(default, default, default, default, default),
            new InstancedMesh(default, default, default, default, default, default, default),
            new InstancedMesh(default, default, default, default, default, default, default),
            new Circle(default, default, default, default, default, default),
            new Trapezium(default, default, default, default, default, default, default, default),
            new Trapezium(default, default, default, default, default, default, default, default),
            new Nut(default, default, default, default, default),
            new GeneralRing(default, default, default, default, default, default, default, default, default),
            new Quad(default, default, default, default, default),
            new GeneralCylinder(
                default,
                default,
                default,
