namespace CadRevealComposer.Tests.Utils
{
    ...
    public class AlgebraUtilsToEulersTests
    {
        ...
        public void SimpleTest(float x, float y, float z, float w)
        {
            ...
            Assert.That(xa.EqualsWithinTolerance(xb, 0.001f));
            Assert.That(ya.EqualsWithinTolerance(yb, 0.001f));
            Assert.That(za.EqualsWithinTolerance(zb, 0.001f));
            Assert.That(oa.EqualsWithinTolerance(ob, 0.001f));
        }
