...
public class DrawCallEstimatorTests
{
    ...
    public void ConeAndCylinder()
    {
        var geometry = new APrimitive[]
        {
            new Cone(0f, 0f, Vector3.One, Vector3.One, Vector3.One, 0f, 0f, int.MaxValue, Color.Red, new BoundingBox(-Vector3.One, Vector3.One)),
    ...
    public void SolidClosedGeneralConeTorusAndClosedCylinder()
    {
        ...
        {
            new Cone(0f, 0f, Vector3.One, Vector3.One, Vector3.One, 0f, 0f, int.MaxValue, Color.Red, new BoundingBox(-Vector3.One, Vector3.One)),
            new TorusSegment(0f, Matrix4x4.Identity, 0f, 0f, int.MaxValue, Color.Red, new BoundingBox(-Vector3.One, Vector3.One)),
            new GeneralCylinder(0f, 0f, Vector3.One, Vector3.One, Vector3.One, Vector4.One, Vector4.One, 0f, int.MaxValue, Color.Red, new BoundingBox(-Vector3.One, Vector3.One))
        };
        (long estimatedTriangleCount, int estimatedDrawCalls) = DrawCallEstimator.Estimate(geometry);
