...
/// <summary>
/// Wrapper around i3df-dump.exe. Converts I3D file to json.
/// </summary>
[Cmdlet(VerbsData.Convert, "I3dToJson")]
[OutputType(typeof(string))]
public class ConvertI3dToJsonCmdlet : ExeWrapperCmdlet
{
    ...
    protected override void ProcessRecord()
    {
        ...
        WriteProgress(new ProgressRecord(0, "Processing I3D file", inputPath));
